...
class JadwalImunisasi extends StatefulWidget {
  const JadwalImunisasi({super.key});

  @override
  State<JadwalImunisasi> createState() => _JadwalImunisasiState();
}

class _JadwalImunisasiState extends State<JadwalImunisasi> {
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                  child: BaseButton(
                                ontap: () {
                                  Get.to(AmbilAntrianPage(), transition: Transition.fadeIn);
                                },
