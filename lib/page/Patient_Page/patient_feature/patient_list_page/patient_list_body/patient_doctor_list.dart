...
class PatientDoctorList extends StatefulWidget {
  final bool? passwordMode;

  const PatientDoctorList({super.key, this.passwordMode});

  @override
  State<PatientDoctorList> createState() => _PatientDoctorListState();
}

class _PatientDoctorListState extends State<PatientDoctorList> {
