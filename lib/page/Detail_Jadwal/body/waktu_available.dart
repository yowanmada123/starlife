...
class WaktuAvailable extends StatefulWidget {
  const WaktuAvailable({super.key});

  @override
  State<WaktuAvailable> createState() => _WaktuAvailableState();
}

class _WaktuAvailableState extends State<WaktuAvailable> {
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    Image.asset("assets/icon/ic_icon_pagi.png"),
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    Image.asset("assets/icon/ic_icon_malam.png"),
                    SizedBox(width:c.sw*13),
