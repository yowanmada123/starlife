                  ...
                  GestureDetector(
                    onTap: () async {
                      Clipboard.setData(new ClipboardData(text: "RM101085-101223/012")).then((_) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('RM Number Copied to your clipboard !')));
                      });
                    },
                    child: Container(
                        padding: EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                        decoration: BoxDecoration(color: Color(0xffD0F4FF), borderRadius: BorderRadius.circular(10), border: Border.all(color: OPrimaryColor)),
                        child: Text(
                          "Copy RM",
